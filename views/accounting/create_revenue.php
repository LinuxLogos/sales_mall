...
<body class="bg-gray-100">
    <div class="container mx-auto mt-8">
        <h1 class="text-3xl font-bold mb-6">Add Revenue</h1>
        <form action="/accounting/revenues/create" method="POST" class="bg-white p-8 rounded-lg shadow-md">
            <div class="mb-4">
            ...
            <button type="submit" class="w-full bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600">Add Revenue</button>
        </form>
    </div>
</body>
</html>
